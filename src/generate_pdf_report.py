...
def generate_pdf_report():
    ...
    pdf.cell(200, 10, txt="Customer Churn Prediction - Bank Customer Data", ln=True, align='C')
    pdf.ln(20)
    ...
    pdf.cell(200, 10, txt="1. Introduction & Problem Statement", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    ...
    pdf.multi_cell(190, 10, txt=text1)
    pdf.ln(5)
    ...
    pdf.multi_cell(190, 10, txt=text2)
    pdf.ln(10)
    
    # 3. Dataset Description
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(200, 10, txt="2. Dataset Description", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    ...
    pdf.multi_cell(190, 10, txt=text3)
    pdf.ln(5)
    ...
    pdf.multi_cell(190, 10, txt=text4)
    pdf.ln(10)
    
    # 4. Methodology
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(200, 10, txt="3. Methodology", ln=True, align='L')
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Exploratory Data Analysis (EDA)", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    ...
    pdf.multi_cell(190, 10, txt=text5)
    pdf.ln(5)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Preprocessing", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    ...
    pdf.multi_cell(190, 10, txt=text6)
    pdf.ln(5)
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Modeling", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    ...
    pdf.multi_cell(190, 10, txt=text7)
    pdf.ln(10)
    ...
    # 5. Results
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(200, 10, txt="4. Results", ln=True, align='L')
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Model Comparison", ln=True, align='L')
    ...
    if os.path.exists(metrics_path):
        ...
        pdf.cell(200, 10, txt="Metrics data not found.", ln=True)
        
    pdf.ln(10)
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="ROC Curves", ln=True, align='L')
    roc_img = '../outputs/figures/roc_curves.png'
    if os.path.exists(roc_img):
        pdf.image(roc_img, x=None, y=None, w=150)
    else:
        pdf.set_font("Arial", size=12)
        pdf.cell(200, 10, txt="ROC Curve image not found.", ln=True)
        
    pdf.add_page()
    
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Confusion Matrix (Best Model)", ln=True, align='L')
    ...
    pdf.ln(10)
    pdf.set_font("Arial", 'B', 12)
    pdf.cell(200, 10, txt="Feature Importance", ln=True, align='L')
    feat_img = '../outputs/figures/feature_importance.png'
    if os.path.exists(feat_img):
        pdf.image(feat_img, x=None, y=None, w=150)
    else:
        pdf.set_font("Arial", size=12)
        pdf.cell(200, 10, txt="Feature Importance image not found.", ln=True)
        
    pdf.add_page()
    
    # 6. Key Findings
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(200, 10, txt="5. Key Findings", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    findings = [
    ...
    for finding in findings:
        pdf.multi_cell(190, 10, txt=finding)
    pdf.ln(10)
    ...
    # 8. Limitations
    pdf.set_font("Arial", 'B', 14)
    pdf.cell(200, 10, txt="7. Limitations", ln=True, align='L')
    pdf.set_font("Arial", size=12)
    limitations = [
